  ...
  render() {
    return (
      <div>
        ...
        <ProgressBar width="350px" percent={50} name="NodeJS" />
        <ProgressBar width="350px" percent={45} name="Graphql" />
        <ProgressBar width="350px" percent={40} name="Mongo" />
        <ProgressBar width="350px" percent={50} name="Docker" />
        <ProgressBar width="350px" percent={10} name="Kubernetes" />
